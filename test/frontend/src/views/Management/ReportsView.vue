<template>
  ...
  <CreateUser ref="createUserPopup" :UserProfiles="userProfiles" @create="handleCreateCategory" />
</template>
...
async function handleCreateCategoryBtn() {
  createUserPopup.value.openPopup()
}

async function handleCreateCategory(details: CreateUserType) {
  try {
