<template>
  ...
  >
    ...
    <div class="border-t pt-3">
      <h3 class="font-semibold text-gray-800 mb-1">Profile Information</h3>
...
const emit = defineEmits<{
  ...
  (e: 'suspend', userProfileID: number): void
}>()
...
function handleUpdateClick() {
  ...
  emit('update', editUserProfile.value)
}
function handleSuspendClick() {
  emit('suspend', props.userProfile?.UserProfileID ?? 0)
}
